...
<div class="breadcrumbs container">
        ...
        <li class="breadcrumbs__li">
            <a href="motors.php" class="breadcrumbs__a">Motors</a>
        </li>
        <li class="breadcrumbs__li">
            <a href="motors-havells.php" class="breadcrumbs__a">Havells Motors</a>
        </li>
        <li class="breadcrumbs__li">Premium Series IE3</li>
        </ul>
    </div>
...
<div class="product-details content-section">
    ...
    <div class="product-details__col1">
        <div class="piczoomer">
        <img src="assets/images/premium-series ie3-lg.webp" alt="cutter-pumpset" class="product-details__image" width="450" height="450">
            </div>
        </div>
        <div class="product-details__col2">
        <h2 class="product-details__name">Premium Series IE3</h2>
        <img src="assets/images/brands-havells-logo-thumb.svg" class="product-details__brand" alt="havells">
        ...
        <div class="product-details__description-block">
            ...
            <p class="product-details__description-block-description">Totally Enclosed Fan Cooled (TEFC) Squirrel Cage Induction Motors - Foot Mounted (B3)
Horizontal Foot Mounted Induction Motor suitable for 415 V ± 10%, 3 Phase, 50 Hz ± 5%, Insulation Class ‘F’, Degree of protection IP 55, Ambient of 50 °C conforming to IS 12615:2018, IEC 60034</p>
        </div>
