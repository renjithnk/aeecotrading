...
<div class="breadcrumbs container">
        ...
        <li class="breadcrumbs__li">
            <a href="pumps.php" class="breadcrumbs__a">Pumps</a>
        </li>
        <li class="breadcrumbs__li">
            <a href="pumps-wilo.php" class="breadcrumbs__a">Wilo Pumps</a>
        </li>
        <li class="breadcrumbs__li">UL-FM Certified Pump</li>
        </ul>
    </div>
...
<div class="product-details content-section">
    ...
    <div class="product-details__col1">
        <div class="piczoomer">
        <img src="assets/images/ul-fm-certified-pump-lg.webp" alt="ul-fm-certified-pump-lg" class="product-details__image" width="450" height="450">
            </div>
        </div>
        <div class="product-details__col2">
        <h2 class="product-details__name">UL-FM Certified Pump</h2>
        <p class="product-details__description">Low-pressure centrifugal pump with axially split housing mounted on a baseplate</p>

        <div class="product-details__description-block">
            <h3 class="product-details__description-block-heading">Application</h3>
            <h4 class="product-details__description-block-subheading">Motor/Engine driven pumps suitable for : </h4>
